...
var app = {
    ...
    storeToken: function(token) {
		alert("storetoken");
           ...
           xmlhttp.open("POST","http://data.invtr.co/registerDevice",true);
           xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		   
		   // TODO user id from logged in session
           xmlhttp.send("token="+token+"&userId=005i0000001GM5rAAG");
